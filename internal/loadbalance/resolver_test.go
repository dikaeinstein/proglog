...
func TestResolverBuilderImplementation(t *testing.T) {
	// won't compile if Resolver does not implement resolver.Builder
	var _ resolver.Builder = (*loadbalance.Resolver)(nil)
}

func TestResolverImplementation(t *testing.T) {
	// won't compile if Resolver does not implement resolver.Resolver
	var _ resolver.Resolver = (*loadbalance.Resolver)(nil)
}
