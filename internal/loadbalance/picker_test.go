...
import (
	...
	"github.com/dikaeinstein/proglog/internal/loadbalance"
)

func TestPickerBuilderImplementation(t *testing.T) {
	// won't compile if Picker does not implement balancer.PickerBuilder
	var _ base.PickerBuilder = (*loadbalance.Picker)(nil)
}

func TestPickerImplementation(t *testing.T) {
	// won't compile if Picker does not implement balance.Picker
	var _ balancer.Picker = (*loadbalance.Picker)(nil)
}
