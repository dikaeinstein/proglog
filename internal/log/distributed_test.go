...
func TestFSMImplementation(t *testing.T) {
	// won't compile if log.FSM does not implement raft.FSM
	var _ raft.FSM = (*fsm)(nil)
}

func TestStreamLayerImplementation(t *testing.T) {
	// won't compile if log.StreamLayer does not implement raft.StreamLayer
	var _ raft.StreamLayer = (*StreamLayer)(nil)
}

func TestLogStoreImplementation(t *testing.T) {
	// won't compile if logstore does not implement raft.LogStore
	var _ raft.LogStore = (*logStore)(nil)
}

func TestFSMSnapshotImplementation(t *testing.T) {
	// won't compile if snapshot does not implement raft.FSMSnapshot
